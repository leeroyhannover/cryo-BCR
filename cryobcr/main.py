...
def setup_extract(subparsers):
    ...
    parser_extract.add_argument('--input_path', type=str, help="Path to the folder containing set of MRC or REC tomogram files to be patchified for training or prediction.")
    ...
    parser_extract.add_argument('--patch_size', type=str, default='128,128,128', help="Size of the extracted patches. Provide as comma-separated list of 3 integer numbers for patches along x,y,z (default: 128,128,128).")
    parser_extract.add_argument('--patch_overlap', type=str, default='0.,0.,0.', help="Fraction (0.0-1.0) of overlap between extracted patches. Provide as comma-separated list of 3 decimal numbers for overlap fractions along x,y,z (default: 0.,0.,0.).")
